...
public class BlockSolarPanel extends UBlockTileEntity {
	...
	public BlockSolarPanel(String name, ISolarPanel solarpanel) {
		super(name + "_" + solarpanel.getName(), UModItemGroups.machines, new BlockProperties(Material.IRON, Material.IRON.getColor()).hardnessAndResistance(1F).sound(SoundType.METAL), UModTileEntityTypes.solarpanel);
