...
public class TileEntityAlloyFurnace extends UTileEntity implements ISidedInventory, IClientEnergy, IInteractionObject, ITickable, ICableExceptor {
	...
	public static final int[] OUT = { 3 }, IN = { 0, 1, 2 };
	...
	public Container createContainer(InventoryPlayer playerInventory, EntityPlayer playerIn) {
		return new ContainerAlloyFurnace(playerIn, world, pos);
	}
