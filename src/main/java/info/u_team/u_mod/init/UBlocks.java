...
public class UBlocks {
	...
	public static final UBlock ore1 = new BlockOre("ore1", EnumResources.createBlockList(EnumResources.BlockType.BLOCK1));
	public static final UBlock ore2 = new BlockOre("ore2", EnumResources.createBlockList(EnumResources.BlockType.BLOCK2));
	
	public static final UBlock block1 = new BlockOre("block1", EnumResources.createBlockList(EnumResources.BlockType.BLOCK1));
	public static final UBlock block2 = new BlockOre("block2", EnumResources.createBlockList(EnumResources.BlockType.BLOCK2));
